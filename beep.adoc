...
In this section, we will discuss the functionnalities and requirements we need from Beep's authentication mechanism.
...
=== 2. Keycloak as an external OIDC provider
...
- External authentication manager thingy
...
=== 3. re-archiecting with keycloak authenticaiton service etc consideration taken in mind
