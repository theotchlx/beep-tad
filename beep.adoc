...
DrawIO components and interactions schema.
...
image::images/rudimentary-overview-current/rudimentary-overview-current.svg[Drawing of Beep's architecture showing the VM, K3s cluster, namespaces and deployments, nested inside each others, with arbitrary sizes and colours.]

The purpose of this schema is for you to have a quick understanding of the curent the components and their interactions. Shapes and sizes have no particular meaning.
...
The below image is a rudimentary overview of Beep's current architecture, as of March 2025.AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA

.Rudimentary overview of Beep's current architecture, as of March 2025. Made with Excalidraw.
image::images/use-case-current/beep-uml-use-case-diagram-trans.svg[Drawing of Beep's architecture showing the VM, K3s cluster, namespaces and deployments, nested inside each others, with arbitrary sizes and colours.]

The purpose of this schema is for you to have a quick understanding of the curent the components and their interactions. Shapes and sizes have no particular meaning.AAAAAAAAAAAAAAAA

==== Separating Beep's functionalities into functional neighborhoods
...
These functional neighborhoods/business capabilities/... can be formally represented using a UML components diagram. Below is the components diagram describing my proposal for Beep's separation into microservices.
