...
// Revues de nos TADs:
// Le plan ne doit pas être les questions. C'est un DAT qui est attendu !! Il faut cependant répondre aux questions. Ou peut être qu'il voulait dire que ça doit pas être des questions avec un "?" dans le titre ?
// Qu'une seule langue
