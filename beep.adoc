...
|Guest
|Create an account
|I can use the features of Beep.

|User
|Get information about my account
|I can review my account information.

|User
|Update my account information
|I can update my ways to recover my account, my authentication mechanisms, language and other information relative to my account.

|User
|Delete my account
|I can remove my account information from the apps and servers.

|User
|Create a server 
|I can grow a community around it.

|User
|Join existing servers
|I can become part of public and private communities.

|Authorized user
|Configure my server
|I can manage the server settings, appearance and user roles.
...
|User
|Send messages
|I can interact with other users in channels inside servers or in private messages.

|User
|Mention other users in messages
|I can notify other users.

|User
|Share files
|I can share files with other users.

|User
|Share my voice, video and screen with other users
|I can communicate with other users with real-time voice, video and screen sharing.
