...
image::appendices/beep-uml-use-case-diagram-light.svg[Fig. I. UML Use Case diagram of Beep.,link=https://beep.theotchlx.me/beep-tad/1/_images/appendices/beep-uml-use-case-diagram-light.svg,window=_blank]
